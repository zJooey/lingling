...
const animation = {
  ...
  add: function(obj, top, left) {
    ...
    // 计算移动步伐
    const t = (top - obj.offsetTop) / this.times
    const l = (left - obj.offsetLeft) / this.times
    ...
    const task = {
      ...
      element: obj,
      step: function() {
        const t = this.element.offsetTop
        this.element.style.top = (t + this.topStep) + 'px'
        const l = this.element.offsetLeft
